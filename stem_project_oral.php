    ...
    <div class="page-wrapper">
        ...
        <section class="mt-5 pt-5 mb-1">
             <div class="container">
                <div class="block-title-two text-center block-title-two__home-five">
                    ...
                    <h3>การประกวดโครงงานสะเต็มศึกษา <br>ระดับ มัธยมศึกษาตอนปลาย (วาจา)</h3>
                </div><!-- /.block-title-two -->
        ...
        <div class="container">
            <div class="row">
                ...
                <?php
                    $sql = "SELECT * FROM stem_project_secondary_oral ORDER BY s_id ASC";
                    $query = mysqli_query($conn,$sql);
                    while($fetch = mysqli_fetch_array($query)){
                ?>
                    <div class="col-xl-4 col-lg-6 col-md-6">
                    <a href="project_detail_oral.php?refcode=<?php echo $fetch['s_id']; ?>">
                        <div class="card">
                        <img class="card-img-top" src="assets/img/bg_gd.jpg" class="img-fluid" alt="">
                          <div class="card-body">
                            <h5 class="card-title f-gradient"> <?php echo $fetch['s_name_project']; ?></h5>
